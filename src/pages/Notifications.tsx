              ...
              filteredNotifications.map((notification) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left px-4 py-3 sm:py-4 transition-colors hover:bg-gray-50 flex items-center gap-3 ${isUnread ? 'bg-orange-50/20' : 'bg-white'
                      }`}
                  >
                    ...
                    <div className="flex-1 min-w-0 flex flex-col md:flex-row md:items-center md:gap-3">
                      <p className={`text-[10px] sm:text-xs font-bold uppercase tracking-widest whitespace-nowrap md:w-56 flex-shrink-0 ${isUnread ? 'text-blue-600' : 'text-gray-500'
                        }`}>
                        {notification.type}
                      </p>
                      <p className={`text-sm sm:text-base flex-1 overflow-wrap-anywhere break-words whitespace-pre-wrap ${isUnread ? 'font-bold text-gray-900' : 'font-medium text-gray-700'
                        }`}>
